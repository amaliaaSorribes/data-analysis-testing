""" La única diferencia con US_creator_agent.py es que toma la carpeta 
del meeting como argumento en vez de procesar todos los meetings y así va más rápido 
desde el backend de la web."""
...
def main():
    MEETINGS_PATH = os.path.join(ALL_MEETINGS_PATH, myMeeting)
    ...
    if "funcional.md" not in files:
        ...
        us_path = os.path.join(BACKLOG_PATH+"/to-do", us_filename)
